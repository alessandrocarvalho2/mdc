...
//using System.Text;
//using Volvo.Ecash.Domain.Interfaces;

//namespace Volvo.Ecash.Domain
//{
//    public abstract class BaseDomain<T> : IDisposable where T : IUnitOfWork
//    {
...
//        /// </summary>
//        protected BaseDomain<T> Parent { get; }
...
//        /// </summary>
//        /// <param name="Configuration">Configuration used for connecting to the database.</param>
//        public BaseDomain(IConfiguration configuration, DbContext context)
//        {
...
//        public BaseDomain(BaseDomain<T> _parent)
//        {
//            this.Parent = _parent;
