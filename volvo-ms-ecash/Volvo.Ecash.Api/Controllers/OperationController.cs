...
namespace Volvo.Ecash.Api.Controllers
{
    ...
    public class OperationController : ControllerBase
    {
        ...
        [HttpGet("GetList")]
        [Authorize("Bearer")]
        public async Task<IActionResult> GetList([FromQuery] OperationFilters filters)
        {
        ...
        [HttpPost("create")]
        [Authorize("Bearer")]
        public async Task<IActionResult> Create([FromBody] Operation inputModel)
        {
            if (inputModel == null)
                return BadRequest();
        ...
        [HttpPut("update/{id}")]
        [Authorize("Bearer")]
        public async Task<IActionResult> Update(int id, [FromBody] Operation inputModel)
        {
